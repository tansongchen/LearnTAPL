...
type nextuvar = NextUVar of string * uvargenerator and uvargenerator = unit -> nextuvar
...
let printcst cst = let _ = List.map (fun (tyS, tyT) -> printty tyS; pr " = "; printty tyT; pr "; ") cst in (); force_newline(); ()
